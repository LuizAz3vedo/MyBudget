                    ...
                    dbc.Modal([
                        ...
                        dbc.ModalBody([
                            ...
                            dbc.Row([
                                ...
                                html.Div(id='teste_teste_receita', style={'padding-top': '20px'}),
                                dbc.ModalFooter([
                    ...
                    dbc.Modal([
                        ...
                        dbc.ModalBody([
                            dbc.Row([
                                dbc.Col([
                                    dbc.Label('Descrição: '),
                                    dbc.Input(placeholder='Ex.: Gasolina, Supermecado...', id='txt-despesa'),
                                ], width=6),
                                dbc.Col([
                                    dbc.Label("Valor: "),
                            ...
                            dbc.Row([
                                ...
                                html.Div(id='teste_teste_despesa', style={'padding-top': '20px'}),
                                dbc.ModalFooter([
...
@app.callback(
    ...
    [
        ...
        State('switche-input-receita', 'value'),
...
@app.callback(
    ...
    [
        ...
        State('switche-input-despesa', 'value'),
...
def add_category(n, n2, txt, check_delete, data):
    ...
    if n2:
        if len(check_delete) > 0:
            cat_despesa = [item for item in cat_despesa if item not in check_delete]
...
def add_category(n, n2, txt, check_delete, data):
    ...
    if n2:
        if len(check_delete) > 0:
            cat_receita = [item for item in cat_receita if item not in check_delete]
